        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastResult = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobRuns", x => x.JobName);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EasterOffset = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CorrectedById = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActorDescription = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestoredDays = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeaveRequests_Employees_CancelledById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_CorrectedById",
                table: "AttendanceRecords",
                column: "CorrectedById");

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_Date_IsFlagged",
                table: "AttendanceRecords",
                columns: new[] { "Date", "IsFlagged" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveBalances_EmployeeId_LeaveType_PeriodStart",
                table: "LeaveBalances",
                columns: new[] { "EmployeeId", "LeaveType", "PeriodStart" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_Status_CreatedAt",
                table: "LeaveRequests",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AttendanceRecords_Employees_CorrectedById",
                table: "AttendanceRecords",
                column: "CorrectedById",
                principalTable: "Employees",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AuditEntries_Employees_ChangedById",
                table: "AuditEntries",
                column: "ChangedById",
                principalTable: "Employees",
                principalColumn: "Id");
